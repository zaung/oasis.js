define("oasis",
  ["oasis/util","oasis/xhr","oasis/connect","rsvp","oasis/logger","oasis/version","oasis/config","oasis/sandbox","oasis/sandbox_init","oasis/events","oasis/service","oasis/iframe_adapter","oasis/webworker_adapter","oasis/inline_adapter","oasis/eloqua_iframe_adapter"],
  function(__dependency1__, __dependency2__, __dependency3__, RSVP, logger, Version, OasisConfiguration, Sandbox, autoInitializeSandbox, Events, Service, IframeAdapter, WebworkerAdapter, InlineAdapter, EloquaIframeAdapter) {
    "use strict";
    ...
    Oasis.reset = function () {
      Oasis.adapters = {
        ...
        eloquaIframe: new EloquaIframeAdapter()
      };
    };
...
define("oasis/eloqua_iframe_adapter",
  ...
  function(__dependency1__, __dependency2__, RSVP, Logger, BaseAdapter) {
    ...
    var EloquaIframeAdapter = extend(BaseAdapter, {
      //-------------------------------------------------------------------------
      // Environment API
