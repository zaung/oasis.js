define("oasis",
  ["oasis/util","oasis/xhr","oasis/connect","rsvp","oasis/logger","oasis/version","oasis/config","oasis/sandbox","oasis/sandbox_init","oasis/events","oasis/service","oasis/iframe_adapter","oasis/webworker_adapter","oasis/inline_adapter","oasis/omc_iframe_adapter"],
  function(__dependency1__, __dependency2__, __dependency3__, RSVP, logger, Version, OasisConfiguration, Sandbox, autoInitializeSandbox, Events, Service, IframeAdapter, WebworkerAdapter, InlineAdapter, OmcIframeAdapter) {
    "use strict";
    ...
    Oasis.reset = function () {
      Oasis.adapters = {
        ...
        omcIframe: new OmcIframeAdapter()
      };
    };
...
define("oasis/omc_iframe_adapter",
  ["oasis/util","oasis/shims","rsvp","oasis/logger","oasis/base_adapter"],
  function(__dependency1__, __dependency2__, RSVP, Logger, BaseAdapter) {
    "use strict";
    var assert = __dependency1__.assert;
    ...
    var OmcIframeAdapter = extend(BaseAdapter, {
      //-------------------------------------------------------------------------
      // Environment API
